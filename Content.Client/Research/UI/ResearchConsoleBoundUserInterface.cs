...
namespace Content.Client.Research.UI
{
    ...
    {
        public IDictionary<string, int> SpecialisationPoints { get; private set; } = new Dictionary<string, int>() { { "points", 0 } };
        ...
        protected override void UpdateState(BoundUserInterfaceState state)
        {
            ...
            SpecialisationPoints = castState.SpecialisationPoints;
